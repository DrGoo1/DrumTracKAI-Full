...
from backend.studiomind_trackai_execution_api import (
    router as studiomind_trackai_execution_router,
)
...
app.include_router(studiomind_trackai_execution_router)
